...
# 🔗 5) Connecter GitHub au LFS Gitea

Dans ton repo GitHub, ajoute un fichier :
...
* GitHub stocke uniquement les pointeurs
* Gitea reçoit les fichiers LFS
* OVH S3 stocke réellement les blobs

---

# 🎮 Cas d’usage : Unreal Engine

Ce setup est idéal pour :
...
Le repo GitHub reste léger.
Les assets lourds vont dans S3 via Gitea.
...
* bucket OVH privé
* clés stockées dans Kubernetes Secret
* accès Gitea en HTTPS uniquement